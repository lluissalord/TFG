...
%El que és voldria mirar d'aconseguir és prenent la solució anterior com a solució inicial, i millorar-ne els pesos i el goal amb l'algorisme PI^2, que requereix d'un aprenentatge per reforç i per tant a base de prova i error es milloren els pesos i el goal.

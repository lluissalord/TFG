...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name policy_msgs-msg:<TrajectoryPoint> is deprecated: use policy_msgs-msg:TrajectoryPoint instead.")))

(cl:ensure-generic-function 'positions-val :lambda-list '(m))
(cl:defmethod positions-val ((m <TrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader policy_msgs-msg:positions-val is deprecated.  Use policy_msgs-msg:positions instead.")
  (positions m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrajectoryPoint>)))
  ...
  (cl:format cl:nil "# Positions of each dimension at a particular point in time~%float64[] positions~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrajectoryPoint)))
  "Returns full string definition for message of type 'TrajectoryPoint"
  (cl:format cl:nil "# Positions of each dimension at a particular point in time~%float64[] positions~%~%~%"))

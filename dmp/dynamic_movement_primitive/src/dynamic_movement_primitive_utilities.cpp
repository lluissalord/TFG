...
bool DynamicMovementPrimitiveUtilities::writeToFile(const std::string& abs_bagfile_name, const dmp_lib::ICRA2009DMPPtr& dmp)//dmp_lib::DMPPtr& dmp)
{
...
bool DynamicMovementPrimitiveUtilities::readFromFile(const std::string& abs_bagfile_name, dmp_lib::ICRA2009DMPPtr& dmp)//dmp_lib::DMPPtr& dmp)
{

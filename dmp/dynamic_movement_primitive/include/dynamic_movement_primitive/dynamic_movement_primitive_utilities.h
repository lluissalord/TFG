...
public:
   ...
   * @return True on success, otherwise False
   */
  static bool writeToFile(const std::string& abs_bag_file_name, const dmp_lib::ICRA2009DMPPtr& dmp);//dmp_lib::DMPPtr& dmp);
   ...
   * @return True on success, otherwise False
   */
  static bool readFromFile(const std::string& abs_bag_file_name, dmp_lib::ICRA2009DMPPtr& dmp);//dmp_lib::DMPPtr& dmp);
